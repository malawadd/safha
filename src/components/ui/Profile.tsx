...
const Profile = ({
  ...
  return (
    <div className="col-span-3">
      <div className="absolute w-full bg-gradient-to-tr from-blue-200 via-pink-200 to-pink-50 h-72">
        {profile.background && (
          <img
      ...
      <div className="p-12 top-36 relative flex lg:flex-row lg:justify-evenly flex-col ">
        <div>
          <div className="mb-2 p-2">
            {avatar && (
              <FallbackImage
                className="shadow-md rounded-lg w-36 h-36 bg-gradient-to-tr from-blue-200 via-pink-200 to-pink-50 object-center object-cover"
                src={avatar}
            ...
            {!avatar && !profile.emoji && (
              <div className="shadow-md rounded-lg w-36 h-36 bg-gradient-to-tr from-blue-200 via-pink-200 to-pink-50"></div>
            )}
          </div>
          <div className="mb-2 p-2">
