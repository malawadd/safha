    ...
    return (
        <div className="my-4 p-4 rounded bg-gray-100">
           ...
           <div className="flex flex-row flex-grow gap-x-1">
              <input
            className="font-mono flex-grow max-w-72 px-2 py-1 mr-4 border border-gray-300 rounded p-4 focus:border-blue-600 focus:outline-none"
            type="text"
            name="source"
            ...
            />
            <input
              className="w-24 px-2 py-1 mr-4 border border-gray-300 rounded p-4 focus:border-blue-600 focus:outline-none"
              type="text"
                name="id"
